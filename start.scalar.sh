...
NETWORK=mainnet
FEATURES=default
DB_FOLDER=${DB_FOLDER:-${HOME}/electrs}
...
case "${1}" in
	...
	;;
	*)
		echo "Usage: $0 (mainnet|testnet|testnet4|regtest|signet|liquid|liquidtestnet)"
		exit 1
	;;
esac
...
#do
	...
	MAIN_LOOP_DELAY=500
	DAEMON_CONF="${DAEMON_CONF_PATH:-${HOME}/${DAEMON}.conf}"
